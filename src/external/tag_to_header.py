...
def fastq_general_iterator(read1_fastq, read2_fastq):
    ...
    while True:
        read1_line = read1_readline().decode()
        read2_line = read2_readline().decode()
    ...
    while read1_line and read2_line:
        ...
        read1_seq_string = read1_readline().decode().rstrip()
        read2_seq_string = read2_readline().decode().rstrip()
        ...
        read1_quality_string = read1_readline().decode().rstrip()
        read2_quality_string = read2_readline().decode().rstrip()
    ...
    for read1_title, read2_title, read1_seq, read2_seq, read1_qual, read2_qual in fastq_general_iterator(read1_fastq, read2_fastq):
        ...
        if o.spacer_seq != None and (read1_seq[o.taglen:o.taglen + o.spclen] != o.spacer_seq or read2_seq[o.taglen:o.taglen + o.spclen] != o.spacer_seq):
            ...
            if (tag1.isalpha() and tag1.count('N') == 0) and (tag2.isalpha() and tag2.count('N') == 0):
                ...
                read1_output.write(('@%s\n%s\n+\n%s\n' % (renamed_read1_title, read1_seq[o.taglen+o.spclen:], read1_qual[o.taglen + o.spclen:])).encode())
                read2_output.write(('@%s\n%s\n+\n%s\n' % (renamed_read2_title, read2_seq[o.taglen+o.spclen:], read2_qual[o.taglen + o.spclen:])).encode())
                goodreads += 1
